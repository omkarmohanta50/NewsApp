...
class SearchFragment : Fragment(R.layout.fragment_search) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsViewModel.searchNews.observe(viewLifecycleOwner, Observer{ responce ->
            when(responce){
                is Resource.Success<*> ->{
                    hideProgressbar()
                    hideErrorMessage()
                    responce.data?.let{newsResponce ->
                        ...
                        val totalPages = newsResponce.totalResults / Constants.QUERRY_PAGE_SIZE +2
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            val isAtLastItem = firstVisibleItemPosition + visibileItemCount >= totalItemCount
